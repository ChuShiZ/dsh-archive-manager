	...
	function apply(ctx) {
		...
		function ArchivedList(props) {
			...
			const renderRow = (s) => {
				...
				}, React.createElement("div", { className: "ds-ardl-meta" }, React.createElement("div", { className: "ds-ardl-title" }, titleOf(s)), React.createElement("div", { className: "ds-ardl-sub" }, subOf(s)), snippetList.length > 0 ? React.createElement("div", { className: "ds-ardl-snippets" }, snippetList.map(renderHit), typeof s.matchCount === "number" && s.matchCount > snippetList.length ? React.createElement("div", { className: "ds-ardl-snippet-more" }, "… 还有 " + (s.matchCount - snippetList.length) + " 处命中") : null) : null), confirming ? React.createElement("div", { className: "ds-ardl-actions" }, React.createElement("button", {
